...
const INITIAL_QNA = [
  {
    id: 1,
    type: "문의",
    title: "정기 후원 납부 방법 문의드립니다.",
    date: "2024.11.19",
    author: "김*민",
    views: 12,
    content: "자동이체 계좌 변경은 어떻게 하나요?",
    status: "답변완료",
  },
  {
    id: 2,
    ...
    author: "이*영",
    views: 5,
    content: "일시적으로 후원하고 싶은데 계좌번호를 알고 싶습니다.",
    status: "답변대기",
  },
];
                ...
                >
                  ...
                  <td className="py-4 px-6 font-medium group">
                    <div className="flex items-center gap-2">
                      <span className="group-hover:text-indigo-600 transition-colors line-clamp-1">
                        {post.title}
                      </span>
                      {post.status === "답변완료" && (
            ...
            >
              ...
              <div className="p-8 md:p-12">
                <div className="flex items-center gap-6 text-xl font-semibold text-slate-500 mb-8 pb-8 border-b border-slate-100">
                  ...
                  <span className="flex items-center gap-2">
                    <Eye className="w-4 h-4" /> {selectedPost.views || 0}
                  </span>
                </div>
                {selectedPost.img && (
                  <img
