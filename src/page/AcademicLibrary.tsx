  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-4 animate-fade-in">
      <div className="text-center mb-12">
        <h2 className="text-6xl font-black text-slate-900 drop-shadow-sm mb-4">자료실</h2>
        <p className="text-slate-500 font-medium">우리원의 사업보고서 및 결산서, 주요 발간 자료를 투명하게 공개합니다.</p>
      </div>
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-[0_15px_40px_-15px_rgba(0,0,0,0.05)] overflow-hidden">
        <div className="divide-y divide-slate-100/80">
          {[
            ...
            <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between p-6 md:p-8 hover:bg-slate-50/80 transition-colors gap-6 group">
